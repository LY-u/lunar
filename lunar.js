...
var calendar = {
  ...
  solar2lunar: function(year, month, day) {
    ...
    return {
      ...
      lMonth: lmonth, //农历月份
      lDay: lday, //农历日期
      Animal: calendar.getAnimal(lyear), //属相：'鼠','牛','虎','兔','龙','蛇','马','羊','猴','鸡','狗','猪'
      IMonthCn: (isLeap ? '\u95f0' : '') + calendar.toChinaMonth(lmonth), //农历月份描述：闰腊月
      IDayCn: calendar.toChinaDay(lday), //农历日期描述：廿一
      cYear: year, //公历年份
      cMonth: month, //公历月份
      cDay: day, //公历日期
      gzYear: gzY, //干支纪年：甲子年
      gzMonth: gzM, //干支纪月：甲子月
      gzDay: gzD, //干支纪日：甲子日
      isToday: isToday, //计算的日期是否今天
      isLeap: isLeap, //计算的月份是否闰月
      nWeek: nWeek, //星期几，星期天为0
      ncWeek: '\u661f\u671f' + cWeek, //中文Unicode：星期三
      isTerm: isTerm, //计算的日期是否节气
      Term: Term, //节气：春分
      astro: astro //计算的日期的星座
    };
  },
  /**
